...
//    fun getCropRecommendation(cropRecommendationData: CropRecommendationData) {
//        viewModelScope.launch {
//            service.cropRecommendation(cropRecommendationData).enqueue(object : Callback<String> {
//                override fun onResponse(
//                    call: Call<String>,
//                    response: Response<String>,
//                ) {
//                    if (response.isSuccessful) {
//                        val prediction = response.body() // This will be the "orange" string
//                        _cropRecommendation.value =prediction // Adjust this to whatever you need in the viewmodel
//                    } else {
//                        val errorMessageJson = response.errorBody()?.string()
//                        _cropRecommendation.value = null
//                    }
